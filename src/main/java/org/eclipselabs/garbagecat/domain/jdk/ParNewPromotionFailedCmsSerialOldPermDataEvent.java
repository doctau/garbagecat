 ...
 * @author jborelo
 */
public class ParNewPromotionFailedCmsSerialOldPermDataEvent implements BlockingEvent, OldCollection, PermCollection,
    ...
    private static final Pattern PATTERN = Pattern.compile(ParNewPromotionFailedCmsSerialOldPermDataEvent.REGEX);
