 ...
 * 
 * <p>
 * Occurs when objects cannot be moved from the young to the old generation due to lack of space or fragmentation. The
 * young generation collection backs out of the young collection and initiates a
 * {@link org.eclipselabs.garbagecat.domain.jdk.CmsSerialOldEvent} full collection in an attempt to free up and compact
 * space. This is an expensive operation that typically results in large pause times.
 * </p>
 * 
 * <p>
...
public class ParNewPromotionFailedEvent implements BlockingEvent {
     ...
     */
    public ParNewPromotionFailedEvent(CharSequence logEntry) {
     ...
     * @param duration
     */
    public ParNewPromotionFailedEvent(CharSequence logEntry, long timestamp, int duration) {
        this.logEntry = logEntry;
