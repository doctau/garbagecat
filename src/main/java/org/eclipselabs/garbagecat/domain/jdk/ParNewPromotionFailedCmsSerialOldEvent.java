...
public class ParNewPromotionFailedCmsSerialOldEvent implements BlockingEvent, OldCollection, PermCollection, YoungData,
    ...
    private static final String REGEX = "^" + JdkRegEx.TIMESTAMP + ": \\[GC " + JdkRegEx.TIMESTAMP
            ...
            + "\\), " + JdkRegEx.DURATION + "\\]" + JdkRegEx.TIMESTAMP + ": \\[(CMS|Tenured): " + JdkRegEx.SIZE + "->"
            ...
            + "?[ ]*$";
    private static final Pattern PATTERN = Pattern.compile(ParNewPromotionFailedCmsSerialOldEvent.REGEX);
     ...
     */
    public ParNewPromotionFailedCmsSerialOldEvent(CharSequence logEntry) {
     ...
     * @param duration
     */
    public ParNewPromotionFailedCmsSerialOldEvent(CharSequence logEntry, long timestamp, int duration) {
        this.logEntry = logEntry;
