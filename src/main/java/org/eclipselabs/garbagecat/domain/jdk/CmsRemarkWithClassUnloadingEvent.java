...
public class CmsRemarkWithClassUnloadingEvent implements BlockingEvent {
    ...
    private static final String REGEX = "^" + JdkRegEx.TIMESTAMP + ": \\[GC\\[YG occupancy: " + JdkRegEx.SIZE + " \\("
            ...
            + ": \\[scrub symbol & string tables, " + JdkRegEx.DURATION + "\\] \\[1 CMS-remark: " + JdkRegEx.SIZE
            + "\\(" + JdkRegEx.SIZE + "\\)\\] " + JdkRegEx.SIZE + "\\(" + JdkRegEx.SIZE + "\\), " + JdkRegEx.DURATION
            + "\\]" + JdkRegEx.TIMES_BLOCK + "?[ ]*$";
    private static final Pattern PATTERN = Pattern.compile(CmsRemarkWithClassUnloadingEvent.REGEX);
     ...
     * @param logEntry
     */
    public CmsRemarkWithClassUnloadingEvent(CharSequence logEntry) {
     ...
     * @param duration
     */
    public CmsRemarkWithClassUnloadingEvent(CharSequence logEntry, long timestamp, int duration) {
        this.logEntry = logEntry;
